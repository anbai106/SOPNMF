...
sopnmf(participant_tsv, participant_tsv, output_dir, tissue_binary_mask, 20, 20, early_stopping_epoch=100, batch_size=8, verbose=True)

# opnmf(participant_tsv, output_dir, tissue_binary_mask, 20, 20, early_stopping_epoch=100, verbose=True)
# apply_to_training(output_dir, 20, tissue_binary_mask, verbose=True)

# ## apply the model to training data
# output_dir = '/run/user/1000/gvfs/sftp:host=cubic-login,user=wenju/cbica/home/wenju/Project/pyOPNMF/results/soPNMF_atlas_WM'
# tissue_binary_mask = '/home/hao/Template_atlas/ISTAGING_3.5D/BLSA_SPGR+MPRAGE_averagetemplate_muse_seg_DS222_250.nii.gz'
# # apply_to_training(output_dir, 17, tissue_binary_mask, verbose=True)
