...
def train(participant_tsv, output_dir, num_component_min, num_component_max, num_component_step=1, max_iter=50000,
          init_method='NNDSVDRandomSVD', tolerance=1e-5, n_threads=8, verbose=False):
    """
    ...
    :param tolerance: the tolerance to achieive for convergence
    ...
    wf = VB_OPNMF(output_dir, participant_tsv, num_component_min, num_component_max, num_component_step,
                                               init_method, max_iter, tolerance, n_threads, verbose)
